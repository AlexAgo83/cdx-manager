...
- request-AC11 -> This task. Proof: **unverified.** Capability detection is unit-tested and requires both starting and observing, but no delegated background run has ever been executed against a real CLI. This is the outstanding evidence debt of this request.
